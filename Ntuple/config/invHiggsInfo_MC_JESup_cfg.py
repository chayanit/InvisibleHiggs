...
# Jet/MET uncertainty
process.invHiggsInfo.jetTag      = cms.untracked.InputTag("shiftedGoodPatJetsEnUpForCorrMEt")
process.invHiggsInfo.metTag      = cms.untracked.InputTag("patType1CorrectedPFMetJetEnUp")
process.invHiggsInfo.puJetMvaTag = cms.untracked.InputTag("puJetMvaEnUp", "full53xDiscriminant")
process.invHiggsInfo.puJetIdTag  = cms.untracked.InputTag("puJetMvaEnUp", "full53xId")
