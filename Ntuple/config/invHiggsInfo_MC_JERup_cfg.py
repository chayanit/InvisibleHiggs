...
# Jet/MET uncertainty
process.invHiggsInfo.jetTag      = cms.untracked.InputTag("smearedGoodPatJetsResUpWithGaussian")
process.invHiggsInfo.metTag      = cms.untracked.InputTag("patType1CorrectedPFMetJetResUpWithGaussian")
process.invHiggsInfo.puJetMvaTag = cms.untracked.InputTag("puJetMvaResUp", "fullDiscriminant")
process.invHiggsInfo.puJetIdTag  = cms.untracked.InputTag("puJetMvaResUp", "fullId")
