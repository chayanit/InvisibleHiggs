...
#include "InvisibleHiggs/Ntuple/interface/ElectronEffectiveArea.h"
...
void ElectronIdSelector<T>::produce(edm::Event& iEvent,const edm::EventSetup& iSetup)
{
  ...
  //std::cout<<"rho = "<<fastJetRho<<std::endl;
  ...
  for(unsigned int iElec=0;iElec<electrons->size();iElec++) { 
    ...
    //std::cout<<"inside electron loops"<<std::endl;
...
//   float EffArea = ElectronEffectiveArea::GetElectronEffectiveArea( ElectronEffectiveArea::kEleGammaAndNeutralHadronIso03 , ele.eta() , ElectronEffectiveArea::kEleEAData2011);
   float EffArea = ElectronEffectiveArea::GetElectronEffectiveArea( ElectronEffectiveArea::kEleGammaAndNeutralHadronIso04 , ele.eta() , ElectronEffectiveArea::kEleEAData2012);
   ...
   Double_t abseta  = fabs(ele.eta());
    ...
    //std::cout<<"pfIso03EA = "<<pfIso03EA<<std::endl;
    //std::cout<<"mvaTrigV0 = "<<mvaTrigV0<<std::endl;
...
// plugin definition
////////////////////////////////////////////////////////////////////////////////
typedef ElectronIdSelector<reco::GsfElectron>     InvHiggsGsfElectronIdSelector;
typedef ElectronIdSelector<pat::Electron>         InvHiggsPATElectronIdSelector;

#include "FWCore/Framework/interface/MakerMacros.h"
DEFINE_FWK_MODULE(InvHiggsGsfElectronIdSelector);
DEFINE_FWK_MODULE(InvHiggsPATElectronIdSelector);
