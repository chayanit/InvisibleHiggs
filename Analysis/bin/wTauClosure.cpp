...
int main(int argc, char* argv[]) {
  ...
  std::cout << "  W+jets reco'd in ctrl (MC estimate in ctrl)            : " << hWTau_MCC_DPhi->GetBinContent(1) << " +/- " << hWTau_MCC_DPhi->GetBinError(1) << std::endl;
  ...
  std::cout << "  W+jets reco'd in ctrl (MC estimate in ctrl)            : " << hWTau_MCC_DPhi->GetBinContent(2) << " +/- " << hWTau_MCC_DPhi->GetBinError(2) << std::endl;
  std::cout << "  W+jets at gen level                                    : " << hWTau_MCGen_DPhi->GetBinContent(1) << " +/- " << hWTau_MCGen_DPhi->GetBinError(1) << std::endl;
  ...
  std::cout << "  W+jets reco'd in ctrl (MC estimate in ctrl)            : " << hWTau_MCC_DPhi->GetBinContent(3) << " +/- " << hWTau_MCC_DPhi->GetBinError(3) << std::endl;
  std::cout << "  W+jets at gen level                                    : " << hWTau_MCGen_DPhi->GetBinContent(1) << " +/- " << hWTau_MCGen_DPhi->GetBinError(1) << std::endl;
  ...
  std::cout << "  W+jets reco'd in ctrl (MC estimate in ctrl)            : " << hWTau_MCC_DPhi->GetBinContent(4) << " +/- " << hWTau_MCC_DPhi->GetBinError(4) << std::endl;
  std::cout << "  W+jets at gen level                                    : " << hWTau_MCGen_DPhi->GetBinContent(1) << " +/- " << hWTau_MCGen_DPhi->GetBinError(1) << std::endl;
  ...
  double y1[4],ey1[4],y2[4],ey2[4],y3[4],ey3[4]; // Fr raw numbers
  
  double diff1[4],ediff1[4]; // Fer Frac diff
  ...
  for(int i=0; i<4; ++i) {
        ...
        y3[i]  = hWTau_MCC_DPhi->GetBinContent(i+1);
        ey3[i] = hWTau_MCC_DPhi->GetBinError(i+1);
        // diff1[i]  = y1[i]-y2[i];
        diff1[i]  = (y1[i]/y2[i])-1.;
  ...
  TGraphErrors *gp_dPhi1      = new TGraphErrors(4,x1,y1,ex1,ey1);
  TGraphErrors *gp_dPhi2      = new TGraphErrors(4,x1,y2,ex1,ey2);
  TGraphErrors *gp_dPhi3      = new TGraphErrors(4,x1,y3,ex1,ey3);
  
  TGraphErrors *gp_dPhiF      = new TGraphErrors(4,x1,diff1,ex1,ediff1);
  TGraphAsymmErrors *gp_dPhiS = new TGraphAsymmErrors(4,x1,y_syst,ex1,ex1,e_syst_l,e_syst_h); // systematic error bands

  TH1D *h = new TH1D("h", "", 1, 0, TMath::Pi()); // For axes
