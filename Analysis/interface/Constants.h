...
namespace constants {
  ...
  static const double syst_WTau_JES_p = 0.11;
  static const double syst_WTau_JER_m = -0.0;
  ...
  static const double syst_QCD3_JER_p  = 0.14;
  ...
  static const double syst_Sig_UES_p[6]  = { 0.011,   0.0022,  0.0037,  0.0, 0.087,  0.0020 };
